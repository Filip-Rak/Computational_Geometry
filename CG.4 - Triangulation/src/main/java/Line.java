...
public class Line implements Drawable
{
    ...
    private double xForVerticalLine;
    private double a, b;
    ...
    public static double[] lineEquation(Line l)
    {
        ...
        double m = (l.p2.getY() - l.p1.getY()) / (l.p2.getX() - l.p1.getX());
    ...
    public void draw(Graphics2D g, int width, int height)
    {
        ...
        if(isInfinite)
        {
            if (isVertical)
            {
                ...
                double newX = centerX + xForVerticalLine;
                g.drawLine((int)newX, 0, (int)newX, height); //height remains constant
            }
            ...
            else
            {
                ...
                double y1 =  (a * (x1 - centerX) + b) + centerY; // y = ax + b, adjusted for x = 0
                double y2 =  (a * (x2 - centerX) + b) + centerY; // y = ax + b, adjusted for x = width

                // Draw the line with adjusted coordinates
                g.drawLine(x1, (int) (height - y1), x2, (int) (height - y2));
            }
        }
        ...
        else
        {
            ...
            double newX1 = p1.getX() + centerX;
            double newY1 = centerY - p1.getY(); //invert Y and adjust
            double newX2 = p2.getX() + centerX;
            double newY2 = centerY - p2.getY(); //invert Y and adjust
    ...
    public static boolean commonPoints(Line l1, Line l2)
    {
        Point p1_1 = l1.getP1();
        Point p1_2 = l1.getP2();
        Point p2_1 = l2.getP1();
        ...
        // Check if any endpoint of line l1 is the same as any endpoint of line l2
        return (Point.pointsEqual(p1_1, p2_1) || Point.pointsEqual(p1_1, p2_2) ||
                Point.pointsEqual(p1_2, p2_1) || Point.pointsEqual(p1_2, p2_2));
    }

    //Getters
    double getA() { return this.a; }
    double getB() { return this.b; }
    double getXForVerticalLine() { return this.xForVerticalLine; }
