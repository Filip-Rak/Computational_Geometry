...
public class Point implements Drawable
{
    ...
    {
        Set<Point> uniquePointsSet = new LinkedHashSet<>(points);
        return new LinkedList<>(uniquePointsSet);
    }

    public static LinkedList<Point> extractPoints(LinkedList<Triangle> triangles)
    {
